" 'roxscource.vim' -- Vim color scheme.
" a minimal adjusted flavour of:
...
" orange          #af5f00    rgb(255, 135, 0)      130    9
...
if ($TERM =~ '256' || &t_Co >= 256) || has("gui_running")
    ...
    hi Constant         ctermbg=NONE ctermfg=130  guibg=NONE    guifg=#af5f00 cterm=NONE           gui=NONE
    ...
    hi Pmenu            ctermbg=235  ctermfg=250  guibg=#262626 guifg=#bcbcbc cterm=NONE           gui=NONE
    ...
    hi ErrorMsg         ctermbg=131  ctermfg=235  guibg=#af5f5f guifg=#ffffff cterm=NONE           gui=NONE
    ...
    hi CursorLineNr     ctermbg=233  ctermfg=130  guibg=#202020 guifg=#af5f00 cterm=NONE           gui=NONE
    hi CursorLine       ctermbg=233  ctermfg=NONE guibg=#202020 guifg=NONE    cterm=NONE           gui=NONE
    hi helpLeadBlank    ctermbg=NONE ctermfg=NONE guibg=NONE    guifg=NONE    cterm=NONE           gui=NONE
    hi helpNormal       ctermbg=NONE ctermfg=NONE guibg=NONE    guifg=NONE    cterm=NONE           gui=NONE

    hi StatusLine       ctermbg=234  ctermfg=247  guibg=#262626 guifg=#9e9e9e cterm=NONE           gui=NONE
    hi StatusLineNC     ctermbg=235  ctermfg=240  guibg=#262626 guifg=#585858 cterm=NONE           gui=NONE

    hi StatusLineTerm   ctermbg=234  ctermfg=247  guibg=#1c1c1c guifg=#9e9e9e cterm=NONE           gui=NONE
    hi StatusLineTermNC ctermbg=235  ctermfg=240  guibg=#121212 guifg=#262626 cterm=NONE           gui=NONE
    ...
    hi VertSplit        ctermbg=NONE ctermfg=235  guibg=NONE    guifg=#262626 cterm=NONE           gui=NONE
    ...
    hi DiffText         ctermbg=235  ctermfg=130  guibg=#262626 guifg=#af5f00 cterm=reverse        gui=reverse
    ...
    hi EndOfBuffer ctermbg=NONE ctermfg=234 guibg=NONE guifg=#262626

    " Own colors - Status line
    hi StatusLineModeNormal   ctermbg=white   ctermfg=black   guibg=white     guifg=black     cterm=NONE gui=NONE
    ...
    hi StatusLineGit          ctermbg=236     ctermfg=247     guibg=#303030   guifg=#9e9e9e   cterm=NONE gui=NONE
    hi StatusLineFileAttr     ctermbg=236     ctermfg=247     guibg=#303030   guifg=#9e9e9e   cterm=NONE gui=NONE
    hi StatusLineError        ctermbg=124     ctermfg=white   guibg=#af0000   guifg=white     cterm=NONE gui=NONE
    hi StatusLineWarning      ctermbg=11      ctermfg=black   guibg=#870087   guifg=white     cterm=NONE gui=NONE
    ...
    hi VimwikiHeader3 ctermfg=66 guifg=#578787
    hi VimwikiHeader4 ctermfg=100 guifg=#878700
    hi VimwikiHeader5 ctermfg=101 guifg=#87875f
    hi VimwikiHeader6 ctermfg=209 guifg=#ff875f
    hi def VimwikiBold term=bold cterm=bold ctermfg=242 gui=bold guifg=#6c6c6c
    ...
    if has("gui_running")
        ...
        hi SpellRare      ctermbg=NONE ctermfg=130  guibg=NONE    guifg=NONE    cterm=undercurl      gui=undercurl guisp=#af5f00
    else
        ...
        hi SpellRare      ctermbg=NONE ctermfg=130  guibg=NONE    guifg=#af5f00 cterm=undercurl      gui=undercurl guisp=NONE
    endif
